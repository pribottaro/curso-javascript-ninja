...
operationSignal = '-';
var subtracao = calculator(operatorSignal);
console.log(showOperationMessage(operationSignal, number1, number2),
subtracao(number1, number2) !== false ? subtracao(number1, number2) : showErrorMessage(operationSignal) );


operationSignal = '*';
var multiplicacao = calculator(operationSignal);
console.log(showOperationMessage(operationSignal, number1, number2),
multiplicacao(number1, number2) !== false ? multiplicacao(number1, number2) : showErrorMessage(operationSignal) );

operationSignal = '/';
var divisao = calculator(operationSignal);
console.log(showOperationMessage(operationSignal, number1, number2), 
divisao(number1, number2) !== false ? divisao(number1, number2) : showErrorMessage(operationSignal));

operationSignal = '%';
var modulo = calculator(operationSignal);
console.log(showOperationMessage(operationSignal, number1, number2), 
modulo(number1, number2) !== false ? modulo(number1, number2) : showErrorMessage(operationSignal));
