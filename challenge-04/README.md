...
isTruthy({idade: 10, sexo: 'masculino'});
...
carro.adicionaPessoas = function(numeroPessoas) {
	var assentosQueFaltam = carro.assentos - carro.quantidadePessoas;
	var totalPessoas = carro.quantidadePessoas + numeroPessoas;

	if(carro.quantidadePessoas === carro.assentos && totalPessoas > carro.assentos) {
		return "O carro já está lotado!";
	} else if (assentosQueFaltam < numeroPessoas && totalPessoas > carro.assentos) {
		return (assentosQueFaltam === 1) ? "Só cabem mais " + assentosQueFaltam + " pessoa!" : "Só cabem mais " + assentosQueFaltam + " pessoas!";
	} else {
